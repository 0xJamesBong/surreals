...
// contract VNO_no_factorisation_saved is ERC721, Ownable, ReentrancyGuard {
//     using LibString for *;
...
//     ) public pure returns (string memory successor) {
...
//         string memory nestedSet
//     ) public view returns (string memory predecessor) {
//         (bool isNestedString, , ) = isNestedString(nestedSet);
//         require(isNestedString == true, "nestedSet is not legal nested string");
...
//         string memory nestedSet1,
//         string memory nestedSet2
//     ) public view returns (string memory addedNestedSet) {
//         (bool isNestedString1, , ) = isNestedString(nestedSet1);
//         (bool isNestedString2, , ) = isNestedString(nestedSet2);
//         require(
//             isNestedString1 == true,
...
//             return
//                 predecessorString(
//                     concat(substring1, successorString(nestedSet2), substring2)
//                 );
//         }
//     }
...
//         string memory nestedSet1,
//         string memory nestedSet2
//     ) public view returns (string memory multipliedNestedSet) {
//         (bool isNestedString1, , ) = isNestedString(nestedSet1);
//         (bool isNestedString2, , ) = isNestedString(nestedSet2);
//         require(
//             isNestedString1 == true,
...
//     mapping(uint256 => uint256) public universal_to_tax;
...
//     function setPaymentToTreasury(uint256 bp) public onlyOwner {
...
//             // recall that universal taxes are set as whole numbers, not percentages
//             universalToBalance[targetNum] +=
//                 (tax * (1000000 - paymentToTreasury)) /
//                 1000000;
//             treasuryBalance += (tax * paymentToTreasury) / 1000000;
//             composeMetadata(
//                 targetNum,
...
//         uint256[2] memory generatingTokenIds;
//         return (emptyset, method, generatingTokenIds);
//     }
...
//         Universal memory _universal = num_to_universal[num];

//         uint256[] memory primes = _universal.primes;
...
//                     for (uint256 j = 0; j < l; j++) {
//                         if (alreadyComputedFactorisation[j] != 1) {
//                             allFactors[k + j] = alreadyComputedFactorisation[j];
//                             console.log(
//                                 "copying!",
//                                 alreadyComputedFactorisation[j]
//                             );
...
//     // function myfactorise(
//     //     uint256 num
//     // ) public pure returns (uint256[] memory factors) {
//     //     uint256 n = num;
//     //     uint256 maxNumberOfPrimes = (n.fromUInt().sqrt()).toUInt() + 1;
...
//     //             k += 1;
//     //         } else {
//     //             s1 = floor(sd(int256(p)).div(sd(int256(3))));
//     //             s2 = sd(int256(p - uint256(unwrap(s1)))).div(sd(int256(2)));
//     //             for (uint256 i = 0; i < uint256(unwrap(s1)); i++) {
//     //                 factors[k] = 8;
//     //                 k += 1;
//     //             }
//     //             for (uint256 i = 0; i < uint256(unwrap(s2)); i++) {
//     //                 factors[k] = 4;
//     //                 k += 1;
//     //             }
//     //         }
...
//     //     require(
//     //         !isUniversal(id),
//     //         "Universals are eternal, they cannot be burned."
//     //     );
